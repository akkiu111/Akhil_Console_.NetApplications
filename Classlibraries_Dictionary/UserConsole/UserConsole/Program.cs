                ...
                do
                {
                    ...
                    switch (choice)
                    {
                        ...
                        case 2:
                            ...
                            if (existuserall)
                            {
                                Dictionary<string, Userdata> uservs = usermethods.GetAllUsers();
                                ...
                                foreach (KeyValuePair<string, Userdata> userdatagetall in uservs)
                                {
                                    Console.WriteLine("---------------");
                                    Console.WriteLine("Id        : " + userdatagetall.Value.Id);
                                    Console.WriteLine("FirstName : " + userdatagetall.Value.FirstName);
                                    Console.WriteLine("LastName  : " + userdatagetall.Value.LastName);
                                    Console.WriteLine("Email     : " + userdatagetall.Value.Email);
                                    Console.WriteLine("Password  : " + userdatagetall.Value.Password);
                                    Console.WriteLine("CourseName: " + userdatagetall.Value.CourseName + "\n");
                                    Console.WriteLine("---------------");
